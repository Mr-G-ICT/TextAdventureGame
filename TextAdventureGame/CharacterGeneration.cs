    ...
    class CharacterGeneration
    {
        ...
        private static void AddRacialBonuses(CharStats MainCharacter)
        {
            ...
            foreach (string Bonus in racialbonus)
            {
                ...
                {
                    //apply the bonus to the character statistics this needs turning into a function
                    switch (Bonus)
                    {
                        case "str":
                        ...
                        case "dex":
                            ...
                            break;
                        case "con":                                                   
                            MainCharacter.Constitution = MainCharacter.Constitution + int.Parse(BonusValue[2]);
                            Console.WriteLine("Constitution");
                            MainCharacter.Intelligence = 12;
                            break;
                        case "wis":
                            MainCharacter.Wisdom = MainCharacter.Wisdom + int.Parse(BonusValue[3]);
                            break;
                        case "car":
                            MainCharacter.Charisma = MainCharacter.Charisma + int.Parse(BonusValue[4])
                                break;
                    }
